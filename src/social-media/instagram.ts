...
export async function instagramdlv2(url: string): Promise<Iigdlv2[]> {
    ...
    const { data }: AxiosResponse<string> = await axios({
        ...
        headers: {
            ...
            cookie: '_ga=GA1.2.654346005.1642149344; _gid=GA1.2.1562255413.1642149344; __gads=ID=b4c9d2019034e5ed-227b64f3e5cf003a:T=1642149344:RT=1642149344:S=ALNI_MbtRULwcpAb_-lCLCSUPN5m5rd54A; __atuvc=3%7C2; __atuvs=61e27fc33a272333000; _gat_gtag_UA_142480840_1=1',
